...
<html>
    ...
    <script>
        ...
        $(function() {
            ...
            var tanggalHariIni = date.getDate() + '-' + month + '-' + date.getFullYear();
            ...
            var tanggal_awal = date.setFullYear(tanggal1[2], tanggal1[1], tanggal1[0]);
            var tanggal_akhir = date.setFullYear(tanggal2[2], tanggal2[1], tanggal2[0]);
        ...
        function pilihsemua()
        {
            var transaksi = document.getElementsByName("transaksi[]");
