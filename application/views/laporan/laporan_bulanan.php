    ...
    <form method="post" action='<?php echo base_url('LaporanControl/bulanan'); ?>' onsubmit="return validasi_input(this)">
        <table  align="center" style="width:33%;margin-bottom:3%">
            <tr style='text-align: center'>
                <th style='text-align: center; width: 17%'>PILIH BULAN</th>
                <th style='text-align: center; width: 10%' class='inputTanggal'>
                    <input type='text' id='bulan' name='bln' placeholder='Klik untuk isi' required=''></th>
                ...
                if ($tampil != 0) {
                    ...
                    echo base_url('LaporanControl/cetakBulanan');
